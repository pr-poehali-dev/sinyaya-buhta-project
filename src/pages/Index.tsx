...
const REVIEWS = [
  ...
  ["Елена М.", "Уссурийск · Сентябрь 2025", "Взяли глэмпинг-шатёр — это отдельное счастье. Засыпать под звук прибоя, просыпаться с видом на море. Мечта, которая сбылась.", "https://cdn.poehali.dev/projects/905f43c3-9796-484a-b6a4-5fdc230be13e/files/44040b2c-0c7e-4441-8885-0572bdfcab7d.jpg"],
  ["Сергей Т.", "Владивосток · Август 2025", "Ездили с женой без детей, первый раз за 4 года вдвоём. Взяли домик с видом на море — это было что-то. Утром кофе на веранде, вечером в баню, потом купаться в море. Вот так и надо отдыхать. Уже присматриваем даты на июль.", "https://cdn.poehali.dev/projects/905f43c3-9796-484a-b6a4-5fdc230be13e/files/1889b174-d199-4f09-a197-a7c423f11ca8.jpg"],
  ["Наталья В.", "Находка · Июль 2025", "Приехали с тремя детьми и боялись, что будет хаос. Всё оказалось наоборот — дети носились по пляжу с утра до вечера, аниматоры на выходных, мелководье безопасное. Мы с мужем реально отдохнули, первый раз за долгое время. Спасибо огромное!", "https://cdn.poehali.dev/projects/905f43c3-9796-484a-b6a4-5fdc230be13e/files/61e0ec90-f222-439d-a152-d23a3692542a.jpg"],
  ["Алексей К.", "Хабаровск · Сентябрь 2025", "Бархатный сезон — огонь. Людей меньше, море тёплое, цены чуть ниже. Рыбачил каждое утро с местным гидом — такого краба я ещё нигде не ел. Вечером сами готовили на мангале. Вот это я понимаю — отдых.", "https://cdn.poehali.dev/projects/905f43c3-9796-484a-b6a4-5fdc230be13e/files/e5407750-50f6-447f-af6b-21ea7321090b.jpg"],
  ["Ирина М.", "Уссурийск · Июнь 2025", "Глэмпинг-шатёр с прозрачной стенкой — это вообще отдельная история. Засыпаешь, а перед тобой море и звёзды. Проснулась в 5 утра от рассвета — не пожалела ни секунды. Подруге уже скинула ссылку, едем вместе в августе.", "https://cdn.poehali.dev/projects/905f43c3-9796-484a-b6a4-5fdc230be13e/files/6ea60841-a9fc-454b-8b1a-ea50f52b1b32.jpg"],
  ["Роман Д.", "Артём · Август 2025", "Честно — не ожидал такого уровня за эти деньги. Всё чисто, персонал не навязывается но всегда рядом, еда свежая. Взял SUP первый раз в жизни — понравилось. На следующий день уже два часа катался сам. Вернусь точно, уже не вопрос.", "https://cdn.poehali.dev/projects/905f43c3-9796-484a-b6a4-5fdc230be13e/files/e7da28c3-accb-428c-a1ab-404be72f7442.jpg"],
] as const;
...
function ReviewsCarousel() {
  ...
  const [name, city, text, photo] = REVIEWS[active];
        ...
        >
          ...
          <article className="sb-review-card sb-review-card--carousel" key={active}>
            ...
            <div className="sb-review-card__author">
              <img className="sb-review-card__avatar sb-review-card__avatar--photo" src={photo} alt={name} />
              <div>
